...
export const useLeaveApplication = () => {
    ...
    const actions = {
        ...
        onCreate: async (data) => {
            ...
            if (form.watch("model_for") == "delete_group_leave") {
                try {
                    ...
                    const response = await deleteGroupLeave(preparedData).unwrap();
        ...
        onDeleteGroupApplication: async () => {
            form.reset({ openModel: true, model_for: "delete_group_leave", ...defaultValue })
        },
     
        onApproveSingleApplication: async () => {
            form.reset({openModel: true, model_for: "approve_single_leave",...defaultValue})
        },
